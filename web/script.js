...
const RESOURCE_POINTS = [
  ...
  { id: 'st-crolles', name: 'STMicroelectronics Crolles', type: 'lieu_vital', active: true, lat: 45.26774620351784, lon: 5.883151084678874, address: '850 Rue Jean Monnet, 38920 Crolles', priority: 'vital', info: 'Site industriel stratégique pour la filière microélectronique nationale.', source: 'https://www.st.com' },
  ...
  { id: 'seveso-seqens-bj', name: 'Pcas - Seqens', type: 'lieu_risque', active: true, lat: 45.5860438, lon: 5.2772265, address: '38300 Bourgoin-Jallieu', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.02822).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  { id: 'seveso-finorga', name: 'Finorga-Novasep', type: 'lieu_risque', active: true, lat: 45.5789437, lon: 4.8114503, address: '38670 Chasse-sur-Rhône', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.02857).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  ...
  { id: 'seveso-sobegal-domene', name: 'Sobegal', type: 'lieu_risque', active: true, lat: 45.2013065, lon: 5.8388954, address: '38420 Domène', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.02904).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  ...
  { id: 'seveso-framatome-jarrie', name: 'Framatome', type: 'lieu_risque', active: true, lat: 45.0926263, lon: 5.7326188, address: '38560 Jarrie', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.02995).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  { id: 'seveso-arkema-jarrie', name: 'Arkema', type: 'lieu_risque', active: true, lat: 45.0895012, lon: 5.7321263, address: '38560 Jarrie', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.02993).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  ...
  { id: 'seveso-suez-pdc', name: 'Suez Rr Iws Chemicals France (Pont-de-Claix)', type: 'lieu_risque', active: true, lat: 45.1236837, lon: 5.6978136, address: '38800 Le Pont-de-Claix', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.06947).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  { id: 'seveso-vencorex-pdc', name: 'Vencorex France', type: 'lieu_risque', active: true, lat: 45.1319656, lon: 5.7064918, address: '38800 Le Pont-de-Claix', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.07527).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  ...
  { id: 'seveso-cerdia-roussillon', name: 'Cerdia France Sas', type: 'lieu_risque', active: true, lat: 45.3735991, lon: 4.8124049, address: '38150 Roussillon', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.08774).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  { id: 'seveso-tourmaline-stclair', name: 'Tourmaline Real Estate', type: 'lieu_risque', active: true, lat: 45.4385057, lon: 4.7709862, address: '38370 Saint-Clair-du-Rhône', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0104.00404).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  ...
  { id: 'seveso-sigma-sqf', name: 'Sigma Aldrich Chimie', type: 'lieu_risque', active: true, lat: 45.6314982, lon: 5.1106322, address: '38070 Saint-Quentin-Fallavier', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.03159).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  { id: 'seveso-titanobel-stq', name: 'Titanobel', type: 'lieu_risque', active: true, lat: 45.298518, lon: 5.6076814, address: '38210 Saint-Quentin-sur-Isère', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.03169).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  ...
  { id: 'seveso-elkem-salaise', name: 'Elkem Silicones France', type: 'lieu_risque', active: true, lat: 45.3441237, lon: 4.8189855, address: '38150 Salaise-sur-Sanne', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.05222).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  { id: 'seveso-total-serpaize', name: 'Total Raffinage France (Serpaize)', type: 'lieu_risque', active: true, lat: 45.5589, lon: 4.92015, address: '38200 Serpaize', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.02999).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
  ...
  { id: 'seveso-sdsp-villette', name: 'Sdsp', type: 'lieu_risque', active: true, lat: 45.5867649, lon: 4.9140734, address: '38200 Villette-de-Vienne', priority: 'risk', info: 'Établissement SEVESO seuil haut (code S3IC 0061.03259).', source: 'https://www.georisques.gouv.fr/risques/installations/donnees' },
